...
public class kafkaConsumerConfig {
    ...
    public ConsumerFactory<String, CarDTO> carConsumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(), new JsonDeserializer<>(CarDTO.class, false));// useHeadrsIfPresent = false porq não esta sendo usado os headers
    }
